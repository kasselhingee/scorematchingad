...
// ptapellman
Rcpp::XPtr< CppAD::ADFun<double> > ptapellman(veca1 x, veca1 thetavar, Rcpp::XPtr< CppAD::ADFun<double> > plltape, transform<a1type>& tran, bool verbose);
RcppExport SEXP _scorematchingad_ptapellman(SEXP xSEXP, SEXP thetavarSEXP, SEXP plltapeSEXP, SEXP tranSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< veca1 >::type x(xSEXP);
    Rcpp::traits::input_parameter< veca1 >::type thetavar(thetavarSEXP);
    Rcpp::traits::input_parameter< Rcpp::XPtr< CppAD::ADFun<double> > >::type plltape(plltapeSEXP);
    Rcpp::traits::input_parameter< transform<a1type>& >::type tran(tranSEXP);
    Rcpp::traits::input_parameter< bool >::type verbose(verboseSEXP);
    rcpp_result_gen = Rcpp::wrap(ptapellman(x, thetavar, plltape, tran, verbose));
    return rcpp_result_gen;
END_RCPP
}
// ptapesmd
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_scorematchingad_ptapellman", (DL_FUNC) &_scorematchingad_ptapellman, 5},
