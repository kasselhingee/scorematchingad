...
// ptapelltape
pADFun ptapelltape(veca1 z_ad, veca1 theta_ad, Rcpp::XPtr< CppAD::ADFun<double> > pllf, transform_a1type& tran, Eigen::Matrix<int, Eigen::Dynamic, 1> fixedtheta, bool verbose);
