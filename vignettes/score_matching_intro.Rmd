...
\end{equation}
 ...
 then minimising the weighted Hyv\"arinen divergence $\phi(f, f_0)$ is equivalent to minimising the score matching discrepancy [Theorem 1 @scealy2022sc]
\begin{equation}
...
That is, transforming the manifold $M$ changes the divergence between distributions and changes the minimum of $\hat\psi(f_\theta, f_0)$.
