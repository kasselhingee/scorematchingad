...
#' On Linux platforms new models can be fitted with the help of [`customll()`], in a similar fashion to models in the `TMB` package.
#' New manifolds or new transforms require currently require small alterations to the source code of this package.
