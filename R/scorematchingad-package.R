...
#' Currently new models, new manifolds or new transforms require small additions to the source code of this package; eventually it would be nice to enable these additions interactively within `R`.
