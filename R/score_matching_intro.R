...
#'  + \eqn{h(z)} is a function, termed the *boundary weight function*, that is zero on the boundary of \eqn{M} and smooth \insertCite{@Section 3.2, @scealy2022sc}{scorecompdir} or potentially piecewise smooth.
