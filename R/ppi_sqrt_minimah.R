# @title Score matching estimate of the PPI model using a minima-based Hyv\"arinen weight function
# @description Estimates \eqn{A_L} and \eqn{b_L} of the PPI model using score matching and a minimum-like Hyv\"arinen weight function. \eqn{\beta} is fixed.
...
# using a minima-based Hyv\"arinen weight function
