...
#######################################################
##estimator2 calculates estimators Score2ac and Score2 in the article
...
#######################################################
##estimator2SE calculates Score2ac standard errors in the article
##for the model with A_L and b_L estimated and beta fixed.
##prop: compositional data (n by p matrix)
##acut: a_c for h function
##estimate2: the value of Score2ac estimator
...
#######################################################
##estimator1 calculates Score1ac and Score1 estimators in the article
##for the model with A_L and b_L estimated and beta fixed.
##prop: compositional data (n by p matrix)
